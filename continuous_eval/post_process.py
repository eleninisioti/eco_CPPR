...
def post_process(project):
    trial = 0
    gen = 980
    metrics = ["sustainability", "efficiency", "resource_closeness", "resources_sustain", "agent_closeness", "agent_sustain"]

    for metric in metrics:
        with open(project + "/trial_" + str(trial) + "/eval/data/no-reproduction/gen_" + str(gen) + ".pkl", "rb") as f:
        ...
        for agent_idx in agents:
            ...
            save_dir = project + "/trial_" + str(trial) + "/eval/media/post/" + metric
